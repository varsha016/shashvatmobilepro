        ...
        <div className="pt-6 grid grid-cols-1 px-6 py-3 gap-x-6 gap-y-8 sm:grid-cols-4">
                  ...
                  <div className="mt-2">
                    <select
                      ...
                      className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-100 sm:max-w-xs sm:t sm:leading-6 px-2 h-[48px]"
                    >
                  ...
                  <div className="sm:col-span-1">
                    ...
                    className="block text-md  leading-6  "
                  >
                    Transaction Type
                  </label>
                  <div className="mt-2">
                    <select
                      ...
                      className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-md sm:leading-6 px-2 h-[48px]"
                    >
                      <option></option>
                      <option></option>
                      <option></option>
