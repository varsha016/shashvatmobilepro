...
const MRechargeHistory = () => {
    ...
    <div>
        ...
        <div className="pt-6 grid grid-cols-1 px-6 py-3 gap-x-6 gap-y-8 sm:grid-cols-4">
                  ...
                  <div className="sm:col-span-1">
                    <label
                    htmlFor="service"
                    className="block text-sm  leading-6  text-md"
                  >
                    Service Type
                  </label>
                  <div className="mt-2">
        ...
        <SubHeading button="Search History"onClick={handleSearch} />      
       <ul>
        {records.map((record) => (
          <li key={record.id}>{}</li>
        ))}
  ...
  <input type="file" accept=".pdf" />
      <button className="bg-gradient-to-r from-blue-800 to-blue-500 text-white px-4 py-2 shadow-2md text-lg mb-3 cursor-pointer hover:scale-105 transform-origin-center transition-transform rounded-md"
>Upload</button>
  </div> */}
   <div className='bg-white  rounded-lg mb-10 m-5'>
...
export default MRechargeHistory